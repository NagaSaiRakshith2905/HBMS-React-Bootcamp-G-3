...
public class PaymentServiceTest {
    ...
    @Test
    void getPaymentByIdWithException(){
        when(paymentRepository.findById(101)).thenThrow(PaymentsNotFoundException.class);
        assertThrows(PaymentsNotFoundException.class,()->paymentService.viewPayment(101));
    }
}