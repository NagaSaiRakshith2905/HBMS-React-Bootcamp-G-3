...
public class LoginServiceTest {
    ...
    void userLogin() {
        ...
        when(userRepository.findUser(user_name)).thenReturn(Optional.of(userDetails));
    ...
    void getUserByUsernameWithException(){
        when(userRepository.findUser("user")).thenThrow(UserNotFoundException.class);
        assertThrows(UserNotFoundException.class,()->userService.loginUser("user","1234"));
    }
}
