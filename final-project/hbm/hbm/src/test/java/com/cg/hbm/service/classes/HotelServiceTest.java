...
public class HotelServiceTest {
    ...
    @Test
    void getHotelByIdWithException(){
        when(hotelRepository.findById(101)).thenThrow(HotelNotFoundException.class);
        assertThrows(HotelNotFoundException.class,()->hotelService.showHotel(101));
    }
}